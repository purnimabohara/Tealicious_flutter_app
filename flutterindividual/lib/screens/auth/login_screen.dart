...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: _formKey,
      child: Scaffold(
        backgroundColor: Color(0xFFEED9E1),
        body: Center(
              ...
              child: Column(
                children: [
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                          backgroundColor: MaterialStateProperty.all(Color(
                              0xFFD58DA6)),
                          shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(borderRadius: BorderRadius.circular(20), side: BorderSide(color: Colors.pink.shade100))),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        "Don't hve an account ? Create on ",
                        style: TextStyle(color: Colors.grey.shade800),
                      ),
                      InkWell(
                          onTap: () {
                          ...
                          child: Text(
                            "Sign up",
                            style: TextStyle(color: Color(0xFFFE53CE) ),
                          ))
                    ],
                  ),
                ],
